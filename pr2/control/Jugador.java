 ...
 * movimiento ejecutar a continuación, le pregunta al jugador que tiene el
 * turno. NO es un concepto de la partida (que va recibiendo las órdenes de qué
 * movimientos ejecutar), sino del que controla el flujo de ejecución de la
 * aplicación. De ahí que esté en el paquete control y no en el paquete logica.
 * 
...
public interface Jugador {
	 ...
	 *            implementaciones no tienen por qué hacer uso de este
	 *            parámetro, si los objetos han sido configurados previamente en
	 *            el momento de la construcción. Se añade para facilitar la
	 *            implementación de algunas clases derivadas.
	 *            
