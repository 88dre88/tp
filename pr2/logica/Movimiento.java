...
public abstract class Movimiento {
	 ...
	 * 
	 * @param donde
	 *            Columna en la que se colocará la ficha
	 * @param color
	 *            Color de la ficha que se pondrá (o jugador que pone)
	 */
	...
	/**
	 * Ejecuta el movimiento sobre el tablero que se recibe como parámetro. Se
	...
	/**
	 * Deshace el movimiento en el tablero recibido como parámetro. Se puede dar
	 * por cierto que el movimiento se ejecutó sobre ese tablero; en caso
	 * contrario, el comportamiento es indeterminado. Por lo tanto, es de
	 * suponer que el método siempre funcionará correctamente.
	 * 
	 * @param tab
